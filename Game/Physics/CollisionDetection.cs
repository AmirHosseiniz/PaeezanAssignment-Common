namespace PaeezanAssignment_Server.Common.Game.Physics
{
    ...
    public static class CollisionDetection
    {
        ...
        private static bool BoxBoxCollision(PhysicsBody a, PhysicsBody b, FixedVector3 posA, FixedVector3 posB,
            out CollisionInfo info)
        {
            ...
            if (overlap.y < minOverlap)
            {
                ...
                normal = delta.y > Fix64.Zero ? -FixedVector3.Up : FixedVector3.Up;
            }

            if (overlap.z < minOverlap)
            {
                minOverlap = overlap.z;
                normal = delta.z > Fix64.Zero ? -FixedVector3.Forward : FixedVector3.Forward;
            }
        ...
        private static bool SphereSphereCollision(PhysicsBody a, PhysicsBody b, FixedVector3 posA, FixedVector3 posB,
            out CollisionInfo info)
        {
            info = new CollisionInfo { BodyA = a, BodyB = b, IsTriggerPair = a.IsTrigger || b.IsTrigger };
        ...
        private static bool BoxSphereCollision(PhysicsBody box, PhysicsBody sphere, FixedVector3 boxPos,
            FixedVector3 spherePos, out CollisionInfo info)
        {
